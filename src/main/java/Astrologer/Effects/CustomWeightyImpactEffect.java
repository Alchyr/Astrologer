...
public class CustomWeightyImpactEffect extends AbstractGameEffect {
    ...
    public CustomWeightyImpactEffect(float x, float y) {
        this(x, y, new Color(1.0F, 1.0F, 0.1F, 0.0F), false);
    }

    public CustomWeightyImpactEffect(float x, float y, Color newColor) {
        this(x, y, newColor, false);
    }

    public CustomWeightyImpactEffect(float x, float y, Color newColor, boolean mute) {
